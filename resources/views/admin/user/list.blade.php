...
<nav class="navbar navbar-expand justify-content-center" style="background-color: transparent;">
           ...
           <tr>
             <td>
               <label for="employeeCheckbox">
                 <input type="checkbox" class="employeeCheckbox" id="employeeCheckbox" />
               </label>
             </td>
  ...
  <!-- Popup Edit Form -->
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true" s>
