...
<style>
  ...
  .nav-links {
    transition: background-color 0.3s ease, color 0.3s ease, margin 0.3s ease, box-shadow 0.3s ease;
  }
...
<div class="row nav-tabs" role="tablist" style="border: none; width: 30vw;">
    ...
    <a class="nav-links active" href="#batch" id="batch-tab"data-bs-toggle="tab" role="tab" aria-controls="batch" aria-selected="true">Batch</a>
    <a class="nav-links" href="#batchcontrol" id="control-batch-tab"data-bs-toggle="tab" role="tab" aria-controls="batchcontrol" aria-selected="true">Batch Control</a>
  </div>
          ...
          <table class="table">
              ...
              <tbody id="tableBody">
                  <tr>
                      ...
                      <td style="text-align: center; justify-items: center; align-items: center;">Undergraduated</td>
                     <td style="text-align: center;"> 
                          <button onclick="" style="border: none; background-color: transparent;" data-bs-toggle="modal" data-bs-target="#Editbatch">
  ...
  <div class="modal fade" id="Editbatch" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
